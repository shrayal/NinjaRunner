  ...
  if(level===0){
    background(bg1)
     ...
     textSize(20)
      ...
      text("PRESS 'SPACE'TO JUMP",150,175)
text("TOUCHING COIN WILL INCREASE A POINT",150,200)
    text("TOUCHING BOMB WILL DECREASE A POINT",150,225)
    text("TOUCHING FIRE WILL END THE GAME",150,250)
      if(keyDown("S")){
        level=1
      }
  }
